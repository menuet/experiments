...
namespace sample {
    ...
    constexpr auto TableDefinition_for_Person = sqlgen::makeTableDefinition<Person>(
        "person", sqlgen::makeColumnDefinition("id", &Person::id),
        sqlgen::makeColumnDefinition("weight", &Person::weight), sqlgen::makeColumnDefinition("age", &Person::age));
    ...
    TEST_CASE("sqlgen", "[where]")
    {
        ...
        SECTION("TRAITS")
        {
            ...
            SECTION("DataType")
            {
                ...
                }
                {
                    static constexpr auto result =
                        std::is_same_v<double, v2::DataType<v2::Column<double, sample::Person>>>;
                    REQUIRE(result);
                }
            }
            ...
            SECTION("wrapData")
            {
                ...
                }
                {
                    ...
                    static constexpr auto result =
                        std::is_same_v<std::decay_t<decltype(wrapped)>, v2::Value<std::string>>;
                    REQUIRE(result);
                }
                {
                ...
                {
                    const auto& wrapped =
                        v2::detail::wrapData(v2::Column<double, sample::Person>{&sample::Person::weight});
                    static constexpr auto result =
                        std::is_same_v<std::decay_t<decltype(wrapped)>, v2::Column<double, sample::Person>>;
                    REQUIRE(result);
                }
                {
        ...
        SECTION("COMPARISON")
        {
            ...
            SECTION("col(std::string) == std::string")
            {
                ...
                static_assert(
                    std::is_same_v<decltype(cmp), const v2::Comparison<v2::Column<std::string, sample::Person>,
                                                                       v2::Value<std::string>>>,
                    "bad type");
            ...
            SECTION("col(std::string) == dbNull")
            {
                ...
                static_assert(std::is_same_v<decltype(cmp),
                                             const v2::Comparison<v2::Column<std::string, sample::Person>, v2::DbNull>>,
                              "bad type");
        ...
        SECTION("LOGIC")
        {
            ...
            {
                const auto logic =
                    v1::col(&sample::Person::id) == std::string("some id") && v1::col(&sample::Person::age) == 12;
            ...
            {
                const auto logic = v1::col(&sample::Person::id) == std::string("some id") &&
                                   v1::col(&sample::Person::age) == 12 && v1::col(&sample::Person::weight) == 65.5;
            ...
            SECTION("COMP AND COMP OR COMP")
            {
                const auto logic =
                    v1::col(&sample::Person::id) == std::string("some id") && v1::col(&sample::Person::age) == 12 ||
                    v1::col(&sample::Person::weight) == 65.5;
            ...
            {
                const auto logic =
                    v2::col(&sample::Person::id) == std::string("some id") && v2::col(&sample::Person::age) == 12;
            ...
            SECTION("COMP AND COMP AND COMP")
            {
                const auto logic = v2::col(&sample::Person::id) == std::string("some id") &&
                                   v2::col(&sample::Person::age) == 12 && v2::col(&sample::Person::weight) == 65.5;
            ...
            SECTION("COMP OR COMP AND COMP OR COMP")
            {
                ...
                REQUIRE(
                    generatedSql ==
                    "(`person`.`id` = ?1 OR (`person`.`age` = ?2 AND `person`.`weight` = ?3)) OR `person`.`id` = ?4");
            }
            ...
            SECTION("(COMP OR COMP) AND (COMP OR COMP)")
            {
                const auto logic =
                    (v2::col(&sample::Person::id) == std::string("some id") || v2::col(&sample::Person::age) == 12) &&
                    (v2::col(&sample::Person::weight) == 65.5 || v2::col(&sample::Person::id) == "some id");
            ...
            SECTION("(COMP OR NOT COMP) AND NOT (COMP OR COMP)")
            {
                ...
                REQUIRE(generatedSql ==
                        "(`person`.`id` = ?1 OR NOT (`person`.`age` = ?2)) AND NOT (`person`.`weight` = ?3 OR "
                        "`person`.`id` = ?4)");
            }
        }
    }
