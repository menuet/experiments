...
# original recipe on conan-transit: sfml/2.4.1@fr00b0/testing
...
class SFMLConanFile(ConanFile):
    ...
    generators = "cmake"
    license = "zlib/png"
    url = "http://github.com/fr00b0/conan-sfml"
    exports = ["CMakeLists.txt"]
    ZIP_FOLDER_NAME = "SFML-2.4.1"
    so_version = '2.4'
    ...
    def package(self):
        ...
        self.copy(pattern="*.dll", dst="bin",
                  src="install/bin", keep_path=False)
