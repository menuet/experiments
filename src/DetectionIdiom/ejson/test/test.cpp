...
namespace {
    ...
    struct IsConstructibleFromJson
    {
        IsConstructibleFromJson(const json11::Json& json)
            : m_i{ejson::deserialize<int>(json["i"])}, m_s{ejson::deserialize<std::string>(json["s"])}
        {
        }
    ...
    struct HasStaticMemberFromJsonAndIsConstructible
    {
        ...
        HasStaticMemberFromJsonAndIsConstructible(int i, std::string s) : m_i(i), m_s(s)
        {
        }
        ...
        static auto fromJson(const json11::Json& json, ejson::ReturnOptionalTag)
        {
            return stdnext::optional<HasStaticMemberFromJsonAndIsConstructible>(
                HasStaticMemberFromJsonAndIsConstructible{
                    ejson::deserialize<int>(json["i"]),
                    ejson::deserialize<std::string>(json["s"]),
                });
        }
...
TEST_CASE("detect", "[traits]")
{
    SECTION("freeStandingFromJsonObjectExpr")
    {
        ...
        {
            const auto result =
                stdnext::is_detected_v<ejson::detail::freeStandingFromJsonObjectExpr, HasFreeStandingFromJson>;
            REQUIRE(result);
        }
        SECTION("When type has a static member function fromJson returning object")
        {
            // TODO: fix
            // const auto result = stdnext::is_detected_v<ejson::detail::freeStandingFromJsonObjectExpr,
            // HasStaticMemberFromJson>; REQUIRE(!result);
        }
        SECTION("When type is constructible from Json")
        {
            // TODO: fix
            // const auto result = stdnext::is_detected_v<ejson::detail::freeStandingFromJsonObjectExpr,
            // IsConstructibleFromJson>; REQUIRE(!result);
        }
        SECTION("When type has a static member function fromJson returning object and is constructible from Json")
        {
            // TODO: fix
            // const auto result = stdnext::is_detected_v<ejson::detail::freeStandingFromJsonObjectExpr,
            // HasStaticMemberFromJsonAndIsConstructible>; REQUIRE(!result);
        }
    }
    SECTION("freeStandingFromJsonOptionalExpr")
    {
        ...
        {
            const auto result =
                stdnext::is_detected_v<ejson::detail::freeStandingFromJsonOptionalExpr, HasFreeStandingFromJson>;
            REQUIRE(result);
        }
        SECTION("When type has a static member function fromJson returning optional")
        {
            // TODO: fix
            // const auto result = stdnext::is_detected_v<ejson::detail::freeStandingFromJsonOptionalExpr,
            // HasStaticMemberFromJson>; REQUIRE(!result);
        }
        SECTION("When type is constructible from Json")
        {
    ...
    SECTION("staticMemberFromJsonObjectExpr")
    {
        ...
        {
            const auto result =
                stdnext::is_detected_v<ejson::detail::staticMemberFromJsonObjectExpr, HasFreeStandingFromJson>;
            REQUIRE(!result);
        }
        SECTION("When type has a static member function fromJson returning object")
        {
            const auto result =
                stdnext::is_detected_v<ejson::detail::staticMemberFromJsonObjectExpr, HasStaticMemberFromJson>;
            REQUIRE(result);
        }
        SECTION("When type is constructible from Json")
        {
            const auto result =
                stdnext::is_detected_v<ejson::detail::staticMemberFromJsonObjectExpr, IsConstructibleFromJson>;
            REQUIRE(!result);
        }
        SECTION("When type has a static member function fromJson returning object and is constructible from Json")
        {
            const auto result = stdnext::is_detected_v<ejson::detail::staticMemberFromJsonObjectExpr,
                                                       HasStaticMemberFromJsonAndIsConstructible>;
            REQUIRE(result);
        }
    }
    SECTION("staticMemberFromJsonOptionalExpr")
    {
        ...
        {
            const auto result =
                stdnext::is_detected_v<ejson::detail::staticMemberFromJsonOptionalExpr, HasFreeStandingFromJson>;
            REQUIRE(!result);
        }
        SECTION("When type has a static member function fromJson returning optional")
        {
            const auto result =
                stdnext::is_detected_v<ejson::detail::staticMemberFromJsonOptionalExpr, HasStaticMemberFromJson>;
            REQUIRE(result);
        }
        SECTION("When type is constructible from Json")
        {
            const auto result =
                stdnext::is_detected_v<ejson::detail::staticMemberFromJsonOptionalExpr, IsConstructibleFromJson>;
            REQUIRE(!result);
        }
        SECTION("When type has a static member function fromJson returning optional and is constructible from Json")
        {
            const auto result = stdnext::is_detected_v<ejson::detail::staticMemberFromJsonOptionalExpr,
                                                       HasStaticMemberFromJsonAndIsConstructible>;
            REQUIRE(result);
        }
    }
...
TEST_CASE("deserialize", "[parsing]")
{
    SECTION("non-optional")
    {
        ...
        {
            const auto val =
                ejson::deserialize<HasFreeStandingFromJson>(std::string(R"({ "i": 789, "s": "blablah" })"));
            REQUIRE(val.m_i == 789);
        ...
        {
            const auto val =
                ejson::deserialize<HasStaticMemberFromJson>(std::string(R"({ "i": 789, "s": "blablah" })"));
            REQUIRE(val.m_i == 789);
            REQUIRE(val.m_s == "blablah");
        }
        ...
        {
            const auto val =
                ejson::deserialize<IsConstructibleFromJson>(std::string(R"({ "i": 789, "s": "blablah" })"));
            REQUIRE(val.m_i == 789);
            REQUIRE(val.m_s == "blablah");
        }
        SECTION("When type is HasStaticMemberFromJsonAndIsConstructible")
        {
            const auto val = ejson::deserialize<HasStaticMemberFromJsonAndIsConstructible>(
                std::string(R"({ "i": 789, "s": "blablah" })"));
            REQUIRE(val.m_i == 789);
            REQUIRE(val.m_s == "blablah");
        }
    ...
    SECTION("non-optional")
    {
        ...
        SECTION("When type is HasFreeStandingFromJson")
        {
            const auto val = ejson::deserialize<stdnext::optional<HasFreeStandingFromJson>>(
                std::string(R"({ "i": 789, "s": "blablah" })"));
            REQUIRE(val);
            REQUIRE(val->m_i == 789);
            REQUIRE(val->m_s == "blablah");
        ...
        SECTION("When type is HasStaticMemberFromJson")
        {
            const auto val = ejson::deserialize<stdnext::optional<HasStaticMemberFromJson>>(
                std::string(R"({ "i": 789, "s": "blablah" })"));
            REQUIRE(val);
            REQUIRE(val->m_i == 789);
            REQUIRE(val->m_s == "blablah");
        ...
        SECTION("When type is IsConstructibleFromJson")
        {
            const auto val = ejson::deserialize<stdnext::optional<IsConstructibleFromJson>>(
                std::string(R"({ "i": 789, "s": "blablah" })"));
            REQUIRE(val);
            REQUIRE(val->m_i == 789);
            REQUIRE(val->m_s == "blablah");
        ...
        SECTION("When type is HasStaticMemberFromJsonAndIsConstructible")
        {
            const auto val = ejson::deserialize<stdnext::optional<HasStaticMemberFromJsonAndIsConstructible>>(
                std::string(R"({ "i": 789, "s": "blablah" })"));
            REQUIRE(val);
            REQUIRE(val->m_i == 789);
            REQUIRE(val->m_s == "blablah");
