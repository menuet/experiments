...
namespace {
    ...
    struct HasDeletedValue : public HasPublicValue
    {
        void value() = delete;
    };
    ...
    struct ManyParamsConstructor
    {
        ManyParamsConstructor(int i, double d, char) : bob(i), bil(d)
        {
        }
        int bob{};
        double bil{};
...
TEST_CASE("modified optional", "")
{
    ...
    {
        {
            scj::optional<int> opt;
            REQUIRE(!opt);
        }
        {
            scj::optional<int> opt(scj::nullopt);
            REQUIRE(!opt);
        }
        {
            scj::optional<int> opt(123);
            REQUIRE(*opt == 123);
        }
        {
            int i = 123;
            scj::optional<int> opt(i);
            REQUIRE(*opt == 123);
        }
        {
            int i = 123;
            scj::optional<int> opt(std::move(i));
            REQUIRE(*opt == 123);
        }
        {
            scj::optional<int> opt1(1);
            scj::optional<int> opt2(opt1);
            REQUIRE(*opt2 == 1);
            REQUIRE(*opt2 == *opt1);
        }
        {
            scj::optional<int> opt1(1);
            scj::optional<int> opt2(std::move(opt1));
            REQUIRE(*opt2 == 1);
        }
        {
            scj::optional<ManyParamsConstructor> opt(scj::in_place, 1, 1.5, 'a');
            REQUIRE(opt);
            REQUIRE(opt->bob == 1);
        }
#if 0 // TODO: fix it
    ...
    SECTION("operator=")
    {
        ...
        {
            scj::optional<int> opt(1234);
            opt = scj::nullopt;
            REQUIRE(!opt);
        }
        {
            scj::optional<int> opt1(3);
            scj::optional<int> opt2;
            opt2 = opt1;
            REQUIRE(*opt2 == 3);
            REQUIRE(*opt2 == *opt1);
        }
    ...
    SECTION("operator->")
    {
        {
            scj::optional<int> opt;
            REQUIRE_THROWS_AS(opt.operator->(), TestContractFailure);
        }
        {
            scj::optional<ManyParamsConstructor> opt(scj::in_place, 1, 1.5, 'a');
            REQUIRE(opt->bil == 1.5);
        ...
        {
            const scj::optional<int> opt;
            REQUIRE_THROWS_AS(opt.operator->(), TestContractFailure);
        }
        {
            const scj::optional<ManyParamsConstructor> opt(scj::in_place, 1, 1.5, 'a');
            REQUIRE(opt->bil == 1.5);
        }
    }
    ...
    SECTION("operator*")
    {
        {
            scj::optional<int> opt;
            REQUIRE_THROWS_AS(*opt, TestContractFailure);
        }
        {
            scj::optional<int> opt(987);
            REQUIRE(*opt == 987);
        }
        {
            const scj::optional<int> opt;
        ...
        {
            const scj::optional<int> opt(987);
            REQUIRE(*opt == 987);
        }
#if !EXP_PLATFORM_CPL_IS_CLANG
        {
            scj::optional<int> opt;
            REQUIRE_THROWS_AS(*std::move(opt), TestContractFailure);
        }
        {
            scj::optional<int> opt(987);
            REQUIRE(*std::move(opt) == 987);
        }
#endif
        {
            const scj::optional<int> opt;
    ...
    {
        {
            const auto opt = scj::make_optional(123);
            REQUIRE(*opt == 123);
        }
        {
            const auto opt = scj::make_optional<int>();
            REQUIRE(!opt);
        }
        {
            const auto opt = scj::make_optional<int>(scj::in_place);
            REQUIRE(opt);
        }
    }
}
