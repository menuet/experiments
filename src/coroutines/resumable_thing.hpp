...
namespace detail {
    ...
    public:
        ...
        coroutine_ptr(coroutine_ptr&& coptr) : m_coh(coptr.m_coh)
        {
            coptr.m_coh = nullptr;
        }
        ...
        coroutine_ptr& operator=(coroutine_ptr&& coptr)
        {
            m_coh = coptr.m_coh;
            coptr.m_coh = nullptr;
        }
...
public:
    struct promise_type
    {
        ...
        {
            return resumable_thing_void(*this);
        }
        auto initial_suspend()
        {
            return stdnext::suspend_never{};
        }
...
public:
    struct promise_type
    {
        ...
        auto get_return_object()
        {
            return resumable_thing_value(*this);
        }
        auto initial_suspend()
        {
            return stdnext::suspend_never{};
    ...
    int get()
    {
        return m_coptr->promise().m_value;
    }
