...
namespace my {
    ...
    inline typename std::iterator_traits<InputIterT>::difference_type count(InputIterT first, InputIterT last,
                                                                            const ValueT& value)
    {
    ...
    template <typename InputIterT, typename UnaryPredicateT>
    inline typename std::iterator_traits<InputIterT>::difference_type count_if(InputIterT first, InputIterT last,
                                                                               UnaryPredicateT unaryPredicate)
    {
        typename std::iterator_traits<InputIterT>::difference_type c = 0;
        for (; first != last; ++first)
        {
    ...
    std::pair<InputIterT1, InputIterT2> mismatch(InputIterT1 first1, InputIterT1 last1, InputIterT2 first2,
                                                 InputIterT2 last2, BinaryPredicateT binaryPredicate)
    {
    ...
    bool equal(InputIterT1 first1, InputIterT1 last1, InputIterT2 first2, InputIterT2 last2,
               BinaryPredicateT binaryPredicate)
    {
        for (; first1 != last1 && first2 != last2; ++first1, ++first2)
        {
            if (!binaryPredicate(*first1, *first2))
    ...
    namespace detail {
        ...
        inline bool beginsWith(ForwardIterT1 first, ForwardIterT1 last, ForwardIterT2 subFirst, ForwardIterT2 subLast,
                               BinaryPredicateT binaryPredicate)
        {
                                ...
                                BinaryPredicateT binaryPredicate)
    {
        ...
        {
            auto secondChar = firstCharMatch;
            ++secondChar;
    ...
    template <typename ForwardIterT1, typename ForwardIterT2, typename BinaryPredicateT>
    inline ForwardIterT1 find_end(ForwardIterT1 first, ForwardIterT1 last, ForwardIterT2 subFirst,
                                  ForwardIterT2 subLast, BinaryPredicateT binaryPredicate)
    {
        if (subFirst == subLast)
            return last;
    ...
    OutputIterT transform(InputIterT1 inFirst1, InputIterT1 inLast1, InputIterT2 inFirst2, OutputIterT outFirst,
                          BinaryOperationT binaryOperation)
    {
    ...
    template <typename InputIterT, typename OutputIterT, typename UnaryPredicateT>
    OutputIterT remove_copy_if(InputIterT inFirst, InputIterT inLast, OutputIterT outFirst,
                               UnaryPredicateT unaryPredicate)
    {
        for (; inFirst != inLast; ++inFirst)
        {
    ...
    template <typename InputIterT, typename OutputIterT, typename ValueT>
    OutputIterT replace_copy(InputIterT inFirst, InputIterT inLast, OutputIterT outFirst, const ValueT& oldValue,
    ...
    OutputIterT replace_copy_if(InputIterT inFirst, InputIterT inLast, OutputIterT outFirst,
                                UnaryPredicateT unaryPredicate, const ValueT& newValue)
    {
        for (; inFirst != inLast; ++inFirst)
    ...
    std::pair<OutputIterT1, OutputIterT2> partition_copy(InputIterT inFirst, InputIterT inLast,
                                                         OutputIterT1 outFirstTrue, OutputIterT2 outFirstFalse,
                                                         UnaryPredicateT unaryPredicate)
    {
        for (; inFirst != inLast; ++inFirst)
        {
    ...
    std::pair<ForwardIterT, ForwardIterT> equal_range(ForwardIterT first, ForwardIterT last, const T& value,
                                                      Compare compare)
    {
        const auto lowerBound = my::lower_bound(first, last, value, compare);
    ...
    OutputIterT merge(InputIterT1 inFirst1, InputIterT1 inLast1, InputIterT2 inFirst2, InputIterT2 inLast2,
                      OutputIterT outFirst, CompareT compare)
    {
    ...
    OutputItT set_difference(InputItT1 inFirst1, InputItT1 inLast1, InputItT2 inFirst2, InputItT2 inLast2,
                             OutputItT outFirst, CompareT compare)
    {
