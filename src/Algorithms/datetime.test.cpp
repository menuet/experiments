...
namespace datetime { namespace ut {
    ...
    SCENARIO("dates times", "[datetime][!mayfail]")
    {
                ...
                THEN("we get Jan 1st 1970 at 00:00:00.000.000.000")
                {
                    ...
                    AND_WHEN("We transform it back to point")
                    {
                        ...
                        THEN("we get 0")
                        {
                            ...
                            REQUIRE(epochPointDatetimeBack.time_since_epoch().count() ==
                                    -1000000000); // What The Fuck ?
                        }
                    }
                }
            }
        ...
        GIVEN("a calendar date-time July 27th 2016 at 18:15:37.123.456.789")
        {
            ...
            WHEN("We transform it to a char string")
            {
                ...
                const auto someDatetimeString =
                    datetime_cast<std::string>(someCalendarDatetime, format); // Use stdc conversion utility
            ...
            WHEN("We transform it to a wchar_t string")
            {
                ...
                const auto someDatetimeString =
                    datetime_cast<std::wstring>(someCalendarDatetime, format); // Use Windows conversion utility
